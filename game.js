onload = function () {
    ...
    const PreloadState = {
        preload : function () {
            game.load.spritesheet('frog', 'player.png', 18, 20);
            game.load.spritesheet('flag', 'flag.png', 33, 168);
            game.load.image('cloud', 'cloud.png');
            game.load.image('sun', 'sun.png');
            game.load.image('tile', 'tile.png');
            game.load.image('wave', 'wave.png');
    ...
    function createGame() {
        ...
        player = game.add.sprite(24, ground_height - 20, 'frog');
